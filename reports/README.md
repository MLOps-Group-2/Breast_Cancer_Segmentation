...
In total at the end of thursday we had used 22.25 dollars. The cloud compute engine did have the most shares in spending but following close was the cloud storage since we do store alot of data, models and since images are technically stored in buckets via artifact/container registery. Unfortunately, to commence large scale training we did not have the required quotas resulting in a significantly lower usage of credits.
